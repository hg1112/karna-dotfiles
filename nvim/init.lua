      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          if client and client:supports_method('textDocument/inlayHint', event.buf) then
            map('<leader>ui', function() vim.lsp.inlay_hint.enable(not vim.lsp.inlay_hint.is_enabled { bufnr = event.buf }) end, '[U]I: Toggle Inlay Hints')
          end
        end,
      })
  ...
  { -- Autoformat
    ...
    opts = {
      ...
      formatters_by_ft = {
        ...
        markdown = { 'prettier' },
        -- Rust: rustfmt is invoked via rust_analyzer LSP (requires rustup)
      },
    },
  },
